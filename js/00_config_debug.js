// ========================================================
// js/00_config_debug.js
// Firebase Config, Asset Loader, Sound System, Debug Mode
// ========================================================
            ...
            // ══════════════════════════════════════════════
            // 🔧 DEBUG MODE — Dikendalikan oleh Admin
            // ══════════════════════════════════════════════
            const DEBUG_MODE_KEY = 'na_debug_mode';

            function isDebugModeActive() {
                return localStorage.getItem(DEBUG_MODE_KEY) === 'true';
            }

            function applyDebugModeToHUD() {
                const show = isDebugModeActive();
                const fairyBtn   = document.getElementById('fairy-test-btn');
                const skripsiBtn = document.getElementById('skripsi-test-btn');
                if (fairyBtn)   fairyBtn.style.display   = show ? 'flex' : 'none';
                if (skripsiBtn) skripsiBtn.style.display = show ? 'flex' : 'none';
            }
